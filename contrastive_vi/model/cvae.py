...
from contrastive_vi.module.cvae import CVAEModule

logger = logging.getLogger(__name__)


class CVAEModel(ContrastiveTrainingMixin, BaseModelClass):
    """
    Model class for contrastive-VI.
    Args:
    ----
        adata: AnnData object that has been registered via
            `CVAEModel.setup_anndata`.
    ...
    def __init__(
        ...
        self._model_summary_string = "cVAE."
    ...
    def setup_anndata(
        ...
        """
        Set up AnnData instance for cVAE model.
